...
from models import *
from app_code_generator import GenerateAppCode
from closest_school import GenerateSchool


class GenerateApplicants:

    def __init__(self):
        # Update the applicant table
        Applicant.create(first_name='Béla', last_name='Kovács', applicant_city='Eger', status='new')
    ...
    def __generate_school(self):
        ...
        for a in applicants:
            ...
            closest_city = GenerateSchool(a.applicant_city)
    ...
    def __generate_application_code(self):
        ...
        for a in applicants:
            ...
            current_app_code = GenerateAppCode()
